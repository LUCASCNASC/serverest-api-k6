...
export default function () {
  ...
  // 5. CENÁRIO: Exclusão (DELETE /produtos/{id})
  let resDelete = http.del(`${BASE_URL}/produtos/K6leHdfiCeOj8BJ`, null, authHeaders);
  check(resDelete, {
    'DELETE - Status 200 ou 400 (parte de carrinho)': (r) => r.status === 200 || r.status === 400,
  });
